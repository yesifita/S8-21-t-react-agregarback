...
const CardDatosContacto = () => {
  return (
    <>
      <div className="h-64 mr-12 border-2 border-solid w-734 rounded-xl border-secundaryGreyLight2">
        <header className="flex flex-row justify-around mt-4 mb-2">
          ...
          <button className="grid h-8 grid-cols-2 pl-2 mt-1 ml-40 text-center border-2 border-solid rounded-xl w-78 border-secundaryGreyLight2 bg-secundaryGreyLight">
            Editar
