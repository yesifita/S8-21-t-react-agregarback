      ...
      <div className="flex flex-col justify-between py-8">
        <div className="flex flex-col gap-y-3">
          ...
          <Link to={'/postulantes'} className="flex items-center mb-4">
            ...
            {isHovered && <p>Tablero</p>}
          </Link>
          <Link to={'/'} className="flex items-center mb-4">
            <div className="mr-4">
              <img src={iconPostulados} alt="" />
            </div>
            {isHovered && <p>Postulados</p>}
          </Link>
          <Link to={'/empleo'} className="flex items-center mb-4">
            <div className="mr-4">
              <img src={iconPublicarEmpleo} alt="" />
            </div>
            {isHovered && <p>Publicar empleo</p>}
          </Link>
        </div>
        <div className="flex flex-col gap-y-3">
          <Link to={'/profile'} className="flex items-center mb-4">
            ...
            {isHovered && <p>Mi perfil</p>}
          </Link>
          <Link to={'/'} className="flex items-center mb-4">
            <div className="mr-4">
              <img src={iconNotificaciones} alt="" />
            </div>
            {isHovered && <p>Notificaciones</p>}
          </Link>
          <Link to={'/'} className="flex items-center mb-4">
            <div className="mr-4">
              <img src={iconAyuda} alt="" />
            </div>
            {isHovered && <p>Ayudar</p>}
          </Link>
